...
let SubCategoryService = class SubCategoryService {
    ...
    async create(createSubCategoryInput) {
        const subCategory = this.subCategoryRepository.create(createSubCategoryInput);
    ...
    update(id, updateSubCategoryInput) {
        const subCategory = this.subCategoryRepository.create(updateSubCategoryInput);
        subCategory.id = id;
        return this.subCategoryRepository.save(subCategory);
    }
    async remove(id) {
